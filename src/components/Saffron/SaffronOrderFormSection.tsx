...
export default function SaffronOrderFormSection() {
  return (
    <motion.section
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    />
                    <div>
                      <p className="font-medium">Landing Page Design by Himel × 1</p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                  ...
                  <div className="flex justify-between items-center border-b pb-2">
                    <span className="text-sm">Landing Page Design by Himel × 1</span>
                    <span>300.00৳</span>
                  </div>
